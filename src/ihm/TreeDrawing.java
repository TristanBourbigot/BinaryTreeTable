...
class TreeDrawing<E extends Comparable<E>, T> extends Canvas {
	...
	BinaryTreeTable<T,E>.Node myTree;
	static final int RADIUS = 10;

	TreeDrawing(BinaryTreeTable<T,E>.Node node){
	...
	public void drawSubtree(Graphics g,BinaryTreeTable<T,E>.Node tree, int x, int width,int level){
